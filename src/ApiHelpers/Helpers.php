...
namespace ChrisBrosnan\BiblePhp\ApiHelpers;
...
class Helpers
{
     ...
     * 
     * @param string $translation The translation code (e.g., 'eng_kjv').
     ...
     * 
     * @param string $translation The translation code (e.g., 'eng_kjv').
     * @param string $book The book name (e.g., 'GEN').
     ...
     * 
     * @param string $commentary The commentary code (e.g., 'adam-clarke').
     * @param string $book The book name (e.g., 'GEN').
     * @param int $chapter The chapter number.
